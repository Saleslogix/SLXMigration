...
namespace GoldParser
{
    ...
    {
        private static readonly SR ms_loader = new SR();

        private readonly ResourceManager m_resources;

        private SR()
        {
            m_resources = new ResourceManager("GoldParser", GetType().Module.Assembly);
        }
