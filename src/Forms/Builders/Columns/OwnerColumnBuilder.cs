...
{
    [BuilderMappingByEquality("TdxDBTreeListColumn", "FormatType", TxFormatType.ftOwner)]
    public sealed class OwnerColumnBuilder : ColumnBuilder
    {
            ...
            if (BindingPath != null)
            {
                ...
                if (entity != null)
                {
                    ...
                    if (property != null)
                    {
                        ...
                        if (_isObject)
                        {
                            DataPathTranslator.RegisterJoin(BindingPath, new DataPath("SECCODE", "SECCODEID"));
                        }
                    }
                }
            }
        ...
        protected override string BuildDataField(DataPath prefixPath)
        {
            ...
            {
                return (_isObject
                            ? DataPathTranslator.TranslateReference(BindingPath, "SECCODE", "SECCODEID")
